...
class Spider(BaseSpider, Request):
    ...
    def get_info(self):
        ...
        url = f"http://106.14.158.253:8090//getRegisterCount?_search=false&nd={str(int(time.time()*1000))}&size=10&current=1&sidx=&order=asc&startTime={self.today}&endTime={self.today}&channelCode=ka27&_={str(int(time.time()*1000))}"
